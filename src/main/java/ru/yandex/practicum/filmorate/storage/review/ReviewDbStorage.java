...
public class ReviewDbStorage implements ReviewStorage {
    ...
    public Review addReview(Review review) {
        log.debug("Добавление отзыва от пользователя {} на фильм {}", review.getUserId(), review.getFilmId());
        ...
        if (id != null) {
            ...
            log.info("Отзыв успешно добавлен с id: {}", id);
        } else {
            log.error("Не удалось сохранить отзыв и получить id");
    ...
    public Review updateReview(Review review) {
        ...
        if (row > 0) {
            ...
            log.error("не удалось обновить отзыв");
    ...
    public void deleteReview(long id) {
        ...
        if (row > 0) {
            ...
            log.error("не удалось удалить отзыв");
    ...
    public Collection<Review> findAll(Long filmId, int count) {
        ...
        if (filmId != null) {
            reviews = jdbc.query(ReviewSqlQueries.FIND_ALL_BY_FILM, rowMapper, filmId, count);
        } else {
            reviews = jdbc.query(ReviewSqlQueries.FIND_ALL, rowMapper, count);
        }
